        ...
        btnDatHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (arrCart.size() > 0) {
                    ...
                    Toast.makeText(CartActivity.this, "No items in the Shopping Cart", Toast.LENGTH_SHORT).show();
                }
            }
                        ...
                        Snackbar snackbar = Snackbar
                                ...
                                .setAction("Come back", new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        Snackbar snackbar1 = Snackbar.make(relativeLayout, "Restored "+mRecentlyDeletedItem.getTenMon(), Snackbar.LENGTH_LONG);
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    for(int i=0;i<arrId.size();i++){
                        if(arrId.get(i).equals(ds.getKey())) {
                            Notification notification = new Notification(nameCustomer + " just ordered food from your bar","New orders available");

        ...
        doi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(MK1.isEmpty() || MK.isEmpty() || MKcu.isEmpty()){
                    Toast.makeText(ChangePassActivity.this, "Please fill out the form", Toast.LENGTH_SHORT).show();
                }
                else {
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(ChangePassActivity.this, "You have successfully changed your password", Toast.LENGTH_SHORT).show();
                                                ...
                                                Toast.makeText(ChangePassActivity.this, "Exchange failed", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        } else {
                            Toast.makeText(ChangePassActivity.this, "The password entered is incorrect", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }

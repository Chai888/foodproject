...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void DangKy() {
        ...
        if (Email.isEmpty() || Pass.isEmpty() || Name.isEmpty() || Phone.isEmpty() || Address.isEmpty()) {
            process.dismiss();
            Toast.makeText(this, "\n" +
                    "Please fill out the form. ", Toast.LENGTH_SHORT).show();
        }
        else {
                        ...
                        user.sendEmailVerification()
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            process.dismiss();
                                            Toast.makeText(RegisterActivity.this, "Sign Up Success. Please verify Email", Toast.LENGTH_SHORT).show();
        ...
        data.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    ...
                    Notification notification = new Notification(name+" just created an account on the app", "Have a new account");
